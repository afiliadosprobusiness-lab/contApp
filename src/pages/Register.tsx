...
import { Calculator, Mail, Lock, Eye, EyeOff, User } from "lucide-react";
    ...
    <div className="min-h-screen flex">
      <div className="hidden lg:flex lg:w-1/2 gradient-hero items-center justify-center p-12">
        <div className="text-center max-w-md">
          ...
          <p className="text-primary-foreground/80">
            5 días gratis para descubrir cómo ContApp Pe puede transformar tu contabilidad.
          </p>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center p-6">
        <div className="w-full max-w-md">
          ...
          <p className="text-muted-foreground text-sm mb-8">Prueba gratis por 5 días, sin tarjeta</p>
          ...
          <form onSubmit={handleRegister} className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input id="email" type="email" placeholder="tu@correo.com" className="pl-10" required />
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input id="password" type={showPass ? "text" : "password"} placeholder="Mínimo 8 caracteres" className="pl-10 pr-10" required />
